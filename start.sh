...
echo -e "\e[01;34m                             Powered By The404Hacking                            \e[00;37;40m"
echo ""
sleep 0.5
cat << EOF
 $f1██████████ ██████████ ██████████    ███████   ██████████$rst
...
if [ $? != 0 ]; then
  ...
  echo -e "$bld$f2 Github : https://github.com/The404Hacking/TabChi$rst"
  sleep 4
  exit 1
fi
sleep 1.5
while true ; do
  ...
  echo -e "$bld$f2 Github : https://github.com/The404Hacking/TabChi$rst"
  sleep 0.5
  echo -e "$bld$f2 Telegram CH : T.ME/TE1EGAMER $rst"
  sleep 0.5
